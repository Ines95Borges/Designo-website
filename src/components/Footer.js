  ...
  return(
    <footer className="footer">
      ...
      <div className="footer__information-container">
        <div className="footer__address1">
          <address>
        ...
        <div className="footer__address2">
          <address>
        ...
        <div className="footer__social-links">
          ...
          <div className="footer__icon-youtube">
          ...
          <div className="footer__icon-pinterest">
